...
public class MainActivity extends AppCompatActivity {
    ...
    protected boolean onStartGame(View view) {
        ...
        //messageBox.setText(word1 + "" + word2);
        while (scrambledword.length() < word1.length() + word2.length() + 1) {
            ...
            if (counter1 >= word1.length() - 1 && counter2 < word2.length() - 1) {
                scrambledword+= word2.substring(counter2);
                break;
            } else if (counter2 >= word2.length() - 1 && counter1 < word1.length() - 1) {
                scrambledword+= word1.substring(counter1);
                break;
            }
        }
